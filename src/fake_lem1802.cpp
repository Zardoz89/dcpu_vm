...
namespace cpu {
   ...
   const uint16_t Fake_Lem1802::def_font_map[128*2] = {   /// Default font map
   ...
   const uint16_t Fake_Lem1802::def_palette_map[16] = {    /// Default palette
    ...
    void Fake_Lem1802::handleInterrupt()
    {
        ...
        switch (cpu->GetA() ) {
            ...
            case MEM_DUMP_FONT:
                ...
                std::copy_n (Fake_Lem1802::def_font_map, s, 
                        cpu->getMem() + cpu->GetB() );
                break;
            ...
            case MEM_DUMP_PALETTE:
                ...
                std::copy_n (Fake_Lem1802::def_palette_map, s,
                        cpu->getMem() + cpu->GetB() );
                break;
